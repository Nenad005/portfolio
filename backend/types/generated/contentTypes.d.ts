...
export interface ApiCounterCounter extends Schema.CollectionType {
...
export interface ApiExperienceExperience extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Begining: Attribute.Date & Attribute.Required;
    End: Attribute.Date;
...
export interface ApiTechnologyTechnology extends Schema.CollectionType {
  ...
  attributes: {
    Name: Attribute.String & Attribute.Required;
    Image: Attribute.Media<'images'> & Attribute.Required;
    tool: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
