function Intro(){
    return <section id="introduction">
        ...
        <div id="intro-counters">
            <div id="intro-counter-experience">
                <h1 id="intro-counter-number">4+</h1>
                <h2 id="intro-counter-title">YEARS OF CODING</h2>
            </div>
            <div id="intro-counter-projects">
                <h1 id="intro-counter-number">25+</h1>
