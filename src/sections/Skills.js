        ...
        <div id="skills-wrapper" className="w-full flex gap-7 flex-wrap justify-center mt-10 mb-10">
            {skills.map((skill, index) => {
                return <div key={index} id="skill" className="flex flex-col w-fit justify-center items-center">
                    <div className="w-fit h-fit group border-solid border-borderColor border-[1px] p-5 rounded-3xl">
                        <img className="object-contain group-hover:animate-pulse duration-300 group-hover:scale-110 w-[70px] h-[70px]" src={`${backendUri}${skill.attributes.Image.data.attributes.url}`}
        ...
        <div id="tools-wrapper" className="w-full flex gap-7 flex-wrap justify-center mt-10">
            {tools.map((tool, index) => {
                return <div key={index} id="tool" className="flex flex-col w-fit justify-center items-center">
                    <div className="w-fit h-fit group border-solid border-borderColor border-[1px] rounded-3xl p-5">
                        <img className="object-contain group-hover:animate-pulse duration-300 group-hover:scale-110 w-[70px] h-[70px]" src={`${backendUri}${tool.attributes.Image.data.attributes.url}`}
